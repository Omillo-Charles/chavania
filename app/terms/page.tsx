          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2 text-sm max-w-2xl">
                These terms govern your use of the Chavania platform. Please
                read all sections that apply to your role carefully. By using
                Chavania you agree to be bound by these terms.
              </p>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 lg:px-8 py-10">
        ...
        <div className="mt-12 p-6 rounded-2xl border border-border bg-background text-center space-y-3">
          <p className="text-sm text-muted-foreground">
            ...
            and <strong className="text-foreground">{COMPANY}</strong> with
            respect to your use of the Chavania platform.
          </p>
          <p className="text-sm text-muted-foreground">
