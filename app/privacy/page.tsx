          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2 text-sm max-w-2xl">
                This policy explains how Chavania collects, uses, and protects
                your personal data. We are committed to transparency — please
                read the sections relevant to you carefully.
              </p>
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 lg:px-8 py-10">
        ...
        <div className="mt-12 p-6 rounded-2xl border border-border bg-background text-center space-y-3">
          <p className="text-sm text-muted-foreground">
            This Privacy Policy constitutes the entire statement of{" "}
            <strong className="text-foreground">{COMPANY}</strong>'s data
            practices with respect to the Chavania platform.
          </p>
          <p className="text-sm text-muted-foreground">
