...
import { ArrowLeft, ChevronDown, ChevronUp, Cookie } from "lucide-react";
          ...
          <div className="flex items-start gap-5">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-2 text-sm max-w-2xl">
                This policy explains what cookies Chavania uses, why we use
                them, and how you can control them. You are always in control
      ...
      <main className="flex-1 max-w-6xl mx-auto w-full px-4 lg:px-8 py-10">
        ...
        <div className="mt-12 p-6 rounded-2xl border border-border bg-background text-center space-y-3">
          <p className="text-sm text-muted-foreground">
            ...
            <strong className="text-foreground">{COMPANY}</strong> and forms
            part of our broader commitment to transparent data practices.
          </p>
          <p className="text-sm text-muted-foreground">
